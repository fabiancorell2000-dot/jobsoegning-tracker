...
### 1. Virksomhedstype — løn vejer tungere end antal ansatte
Det afgørende er **ikke headcount, men om virksomheden er etableret nok til at
betale markedsløn**. Løn er en vigtig faktor for Fabian.

- **Fravælg startups og venture-finansierede scaleups.** De ligger typisk under
  markedsløn, og det er en dealbreaker — også når kompetencematchet er godt.
- **Etablerede virksomheder under 100 ansatte er derimod fine**, særligt hvis de
  er del af en større koncern (fx Annalect ~52 ansatte, men del af Omnicom) eller
  er en veletableret, indtjenende virksomhed.
- Øvre grænse (~10.000 ansatte) bevares som blød præference, ikke hårdt filter.

Er det uklart, om en lille virksomhed er en scaleup eller en etableret
forretning, så tjek ejerforhold/koncern og nævn usikkerheden i begrundelsen.
...
- **Jobindex.dk** — det største danske jobopslagssite, mange opslag når aldrig
  LinkedIn, og det er netop etablerede danske arbejdsgivere (matcher pkt. 1)

**thehub.io bruges ikke** — den er stort set udelukkende startup- og
scaleup-stillinger, som er fravalgt jf. pkt. 1.
